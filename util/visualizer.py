...
class COCOVisualizer():
    ...
    def visualize(self, img, tgt, caption=None, dpi=300, savedir=None, show_in_console=True):
        ...
        if savedir is not None:
            if caption is None:
                savename = '{}/{}'.format(savedir, tgt['image_name'])
    ...
    def addtgt(self, tgt):
        ...
        prop = mfm.FontProperties(fname='simhei.ttf')
        ...
        if 'box_label' in tgt:
            ...
            for idx, bl in enumerate(tgt['box_label']):
                ...
                ax.text(bbox_x, bbox_y, _string, color='black', bbox={'facecolor': color[idx], 'alpha': 0.6, 'pad': 1},fontproperties=prop,)
