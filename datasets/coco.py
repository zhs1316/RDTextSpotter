...
def build(image_set, args):
    ...
    for dataset_name in dataset_names:
        if dataset_name == 'totaltext_train':
            ...
            img_folder = root / "icdar2015_all" / "train_images"; ann_file = root / "icdar2015_all" / "ic15_train.json"
            ...
            img_folder = root / "icdar2015_all" / "test_images"; ann_file = root / "icdar2015_all" / "ic15_test.json"
            ...
            img_folder = root / "demo" / "train_image";
            ann_file = root / "demo" / "train.json"
        else:
