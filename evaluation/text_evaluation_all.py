...
class TextEvaluator():
    ...
    def __init__(self, task, lexicon_type, use_lexicon, use_customer_dictionary, dataset_name, distributed,
                 output_dir='eavaluate_result'):
