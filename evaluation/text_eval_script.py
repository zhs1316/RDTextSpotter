    ...
    for resFile in gt:
        ...
        if resFile in subm:
            ...
            if len(gtPols)>0 and len(detPols)>0:
                ...
                outputShape=[len(gtPols),len(detPols)] # gtPols: Polygon
...
def text_eval_main(det_file, gt_file, is_word_spotting):
    ...
    return rrc_evaluation_funcs.main_evaluation(None,det_file, gt_file, default_evaluation_params,validate_data,evaluate_method, show_result=False)